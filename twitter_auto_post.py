...
for i in range(30):
    ...
    for movie in movies:
        ...
        #         action_link.send_keys(afe_link_dic[key])
        ...
        dt2 = datetime.timedelta(minutes= 10 + (5 * i) )
        ...
        hour_minuts.send_keys(dt_10leter.strftime('%H:%M %p'))
        ...
        #fullScreenScroll > div > div > div > div:nth-child(5) > div > div._1Mz0FYWQ._3r9Pt5qv > div._1UApdmW3._3r9Pt5qv > div.F9ukX4Vm._3r9Pt5qv > input
        #fullScreenScroll > div > div > div > div:nth-child(5) > div > div._1Mz0FYWQ._3r9Pt5qv > div._1UApdmW3._3r9Pt5qv > div.F9ukX4Vm._3r9Pt5qv > input
